...
class EntriesAPITest extends CLPTestCase {
	...
	public function test_can_get_entries() {
		$entries = $this->clp->entries()->fetchEntries();
	...
	public function test_can_get_all_entries() {
		$entries = $this->clp->entries()->fetchAllEntries([], 600);
	...
	public function test_can_use_continuation_token() {
		...
		$entries = $this->clp->entries()->fetchAllEntries([], 15);
		...
		$nextEntries = $this->clp->entries()->fetchAllEntries([], 15, $continuationToken);
	...
	public function test_can_get_uneven_number_of_entries() {
		$entries = $this->clp->entries()->fetchAllEntries([], 219);
	...
	public function test_can_filter_by_collection() {
		...
		$entries = $this->clp->entries()->fetchAllEntries(["collection_id eq '{$collectionID}'"], 150);
	...
	public function test_can_filter_by_date() {
		...
		$entries = $this->clp->entries()->fetchEntriesAfterTimestamp($cutoffDate, 150, []);
	...
	public function test_can_filter_by_date_and_collection() {
		...
		$entries = $this->clp->entries()->fetchEntriesAfterTimestamp($cutoffDate, 128, ["collection_id eq '{$collectionID}'"]);
